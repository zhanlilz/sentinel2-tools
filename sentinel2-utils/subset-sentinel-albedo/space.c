...
int SetupSpace(long proj_num, long zone, double *proj_param, long sphere, double ul_x, double ul_y, double pix_size)
{
  ...
  //char libgctp[1024];       /* storage for mrttables */
	char *libgctp;
  ...
  //strcpy(libgctp, "/program/MRTSwath/MRTSwath/data");
