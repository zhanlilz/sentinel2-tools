...
int Sensor2MODIS (DIS_LANDSAT * sensor, int irow, int icol,
									GRID_MODIS * modis, int *mrow, int *mcol);
...
int CalculateANratio (int16 * brdf, double SZA, double SAA, double VZA,
											double VAA, double *ANR_wsa, double *ANR_bsa);
int CalculateAlbedo (DIS_LANDSAT * sensor, double *lndPixAlbedo, int row,
										 int col, int8 * QA, int snow_flag);
...
void GetPhaseAngle (double cos1, double cos2, double sin1, double sin2,
										double cos3, double *cosres, double *res, double *sinres);
void GetDistance (double tan1, double tan2, double cos3, double *res);
void GetpAngles (double brratio, double tan1, double *sinp, double *cosp,
								 double *tanp);
void GetOverlap (double hbratio, double distance, double cos1, double cos2,
								 double tan1, double tan2, double sin3, double *overlap,
								 double *temp);
