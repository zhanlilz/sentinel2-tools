...
static void for_init (long proj_num, long zone, double *proj_param,
											long sphere, char *file27, char *file83, long *iflag,
											long (*for_trans[MAX_PROJ + 1]) ());
static void inv_init (long proj_num, long zone, double *proj_param,
											long sphere, char *file27, char *file83, long *iflag,
...
int
SetupSpace (long proj_num, long zone, double *proj_param, long sphere,
						double ul_x, double ul_y, double pix_size)
{
	...
	for_init (proj_num, zone, proj_param, sphere, file27, file83, &iflag,
						for_trans);
	if (iflag != 0)
		{
	...
	inv_init (proj_num, zone, proj_param, sphere, file27, file83, &iflag,
						inv_trans);
	if (iflag != 0)
		{
...
int
ToSpace (double lat, double lon, double *l, double *s)
{
	double x, y;
...
int
FromSpace (double l, double s, double *lat, double *lon)
{
